...
function Footer() {
  return (
    <div><footer aria-label="Site Footer" class="bg-blue-600">
    <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          ...
          >
           ikuti kamin  di sosial media di bawah ini
          </p>
          ...
          <div class="text-center sm:text-left">
            ...
            <nav aria-label="Footer About Nav" class="mt-8">
              <ul class="space-y-4 text-sm">
                <li>
                  <a
                    class="text-white-700 transition hover:text-gray-700/75"
                    href="/"
                  >
                    Company History
                  </a>
            ...
            <ul class="mt-8 space-y-4 text-sm">
              <li>
                ...
                >
                  ...
                  <span class="text-white">john@doe.com</span>
                </a>
              </li>
